 ...
 * Cores alinhadas ao wireframe: preto + laranja marca.
 */
export function WhatsAppCtaButton({
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        "group relative h-12 w-fit overflow-hidden rounded-full border-2 border-brand-orange bg-black p-1 ps-6 pe-14 font-fjalla text-xs uppercase tracking-wide text-brand-orange shadow-none transition-all duration-500 hover:bg-black hover:ps-14 hover:pe-6 hover:text-brand-orange md:text-sm",
        className,
      )}
    >
      <a
